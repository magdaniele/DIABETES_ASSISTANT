...
List<Advices> consejos = [
  ...
  Advices(
    ...
    iconImage: '',
    description: '''La actividad física regular tiene muchos beneficios. El ejercicio puede ayudarte a:
    Bajar de peso
  ...
  Advices(
    3,
    name: 'Consume alimentos vegetales saludables',
    iconImage: '',
    description: '''Los alimentos con un alto contenido de fibra promueven la pérdida de peso y reducen el riesgo de sufrir diabetes. Come una variedad de alimentos saludables con un alto contenido de fibra, por ejemplo:
  ...
  Advices(
    ...
    iconImage: '',
    description: '''Las grasas insaturadas, tanto monoinsaturadas, como poliinsaturadas, favorecen los niveles de colesterol saludable y la buena salud vascular y del corazón. Estas son algunas fuentes de grasas saludables:
  ...
  Advices(
    ...
    iconImage: '',
    description: '''La American Diabetes Association (Asociación Americana de la Diabetes) recomienda exámenes de detección de rutina con pruebas de diagnóstico para la diabetes tipo 2 en todos los adultos de 45 años o más, y en los siguientes grupos:
